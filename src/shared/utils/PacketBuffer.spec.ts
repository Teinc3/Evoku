...
describe('PacketBuffer', () => {
    ...
    describe('Buffer Management', () => {
        ...
        it('should clone the buffer with its exact state', () => {
            ...
            expect(clone.buffer.slice(0, clone.maxWritten)).toEqual(buffer.buffer.slice(0, buffer.maxWritten));
        ...
        it('should automatically resize and double the buffer when writing beyond initial capacity', () => {
