...
export default abstract class CustomCodec<GenericContract extends IDataContract>
  ...
  /**
     ...
     * Each key corresponds to a property in the contract, and the value is a codec constructor.
     * 
  ...
  /**
     ...
     * @param {GenericContract} [data] - The data to encode.
     *  If not provided, uses the packet's internal data.
