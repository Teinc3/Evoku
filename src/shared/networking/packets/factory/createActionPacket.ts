...
export function pickInjectables<
  Mapping extends Record<string, unknown>,
...
/**
 * Creates a packet for a specific GenericAction, allowing for the injection of extendable codecs.
 * 
 ...
 * @param specificCodecMap - A map of remaining codecs for the specific action,
 *   excluding any extendable fields.
 * @returns A packet
 */
