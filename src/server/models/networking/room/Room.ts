...
export default class RoomModel {
  ...
  private trackedTimeouts: Set<ReturnType<typeof setTimeout>>;
  ...
  /** Schedule a timeout that will be automatically cleared when the room closes */
  public setTrackedTimeout(callback: () => void, delayMs: number): ReturnType<typeof setTimeout> {
  ...
  public clearTrackedTimeout(timeoutId: ReturnType<typeof setTimeout>): void {
